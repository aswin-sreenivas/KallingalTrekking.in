...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'The rate is flat ₹2,500 per Jeep. One private 4×4 Jeep accommodates 1 Jeep: 8 persons (including driver). There are no additional per-person charges for your group.'
  },
  {
    id: 'f3',
