...
export const Hero: React.FC<HeroProps> = ({ onNavigate }) => {
  ...
  return (
    <section
      id="home"
      className="relative w-full min-h-[100dvh] py-16 sm:py-20 md:py-28 overflow-hidden flex flex-col items-center justify-center"
    >
      {/* =========================================================
          BACKGROUND VIDEO
      ========================================================== */}
      <div className="absolute inset-0 w-full h-full z-0 overflow-hidden bg-slate-950">
        {!hasVideoError ? (
          ...
          <img
            src={heroBanasuraImg}
            alt="Banasura Hills trekking view"
      ...
      <div className="absolute bottom-3 left-3 sm:bottom-6 sm:left-6 z-20 flex items-center gap-1.5 sm:gap-2">
        ...
        <button
          type="button"
          onClick={togglePlay}
          className="p-2 sm:p-2.5 rounded-lg sm:rounded-xl bg-slate-900/80 hover:bg-slate-900 text-white backdrop-blur-md border border-white/20 transition-all shadow-lg hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white/50"
